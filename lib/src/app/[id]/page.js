...
// //   Sparkles, Utensils, ChevronRight
// // } from "lucide-react";
...
// //       const payload = {
// //         placedBy: "CUSTOMER",
// //         tableNumber: businessType ? null : (params.tableNumber || 1),
...
// //             .map((item) => (
// //               <div key={item._id} className="bg-white px-6 py-8 border-b border-slate-50 last:border-none rounded-[2rem] mb-4">
...
//       const payload = {
//         placedBy: "CUSTOMER",
//         tableNumber: businessType ? null : (tableNumber || ''),
//         customerName: customerData.name || "Guest",
//         customerPhone: customerData.phone,
//         items: cartItemsArray.map((i) => ({
//           itemId: i._id,
...
const formatTime = (seconds) => {
  ...
  const finalOrderPlacement = async () => {
    ...
    try {
      ...
      const payload = {
        placedBy: "CUSTOMER",
        tableNumber: businessType ? null : (tableNumber || "NA"),
        customerName: customerData.name || "Guest",
        customerPhone: customerData.phone,
        items: cartItemsArray.map((i) => ({
          itemId: i._id,
